                    ...
                    d = function() {
                        ...
                        h(d, [{
                            ...
                            value: function(a, b) {
                                ...
                                if (typeof b !== "string" || !D(b)) throw new Error('Invalid Argument: "' + b + '" is not a valid opt-in feature');
                                D(b) && (this.optIns.optIn(a, b, d), t([b].concat(m(B[b] || [])), function(a) {
                                    C[a] && t(C[a], function(a) {
                            ...
                            key: "consent",
                            value: function(a) {
                                a === "revoke" ? this.locks.lockConsent() : a === "grant" ? this.locks.unlockConsent() : y({
                                    action: a,
                            ...
                            value: function(a, b, c, d) {
                                return this.trackSingleGeneric(a, b, c, A.TrackSingleCustom, d)
                            }
                        }, {
                            key: "trackSingleSystem",
                            value: function(a, b, c, d) {
                                return this.trackSingleGeneric(b, c, d, A.TrackSingleSystem, null, a)
                            }
                        }, {
                            ...
                            value: function(a) {
                                ...
                                a = a.userDataFormFields != null && u(a.userDataFormFields).length > 0;
                                return b || a
                            }
                        }, {
                            key: "fire",
                            ...
                            value: function(a) {
                                ...
                                if (!this.fbq.pendingConfigs || w(this.fbq.pendingConfigs, function(b) {
                                        return b === a
                                    }) === !1) {
                                    var b = j.href,
                                        c = i.referrer,
                                    ...
                                    F(a, this.VERSION, this.RELEASE_SEGMENT != null ? this.RELEASE_SEGMENT : "stable", d)
                                }
                            }
                        }, {
                            key: "configLoaded",
        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    n = z.execEnd;
                    var G = z.fired,
                        H = z.getCustomParameters,
                        ca = z.iwlBootstrap,
                        I = z.piiInvalidated,
                        da = z.setIWLExtractors,
                        J = z.validateCustomParameters,
                        K = z.validateUrlParameters,
                        L = o.logError,
                        M = o.logUserError,
                        N = s.global,
                        O = -1,
                    ...
                    function ja(a) {
                        ...
                        switch (a) {
                            ...
                            case "firstPartyCookies":
                                ...
                                typeof q === "string" ? V.callMethod([s, q, "FirstPartyCookies"]) : q === void 0 ? V.disableFirstPartyCookies = !0 : M({
                                    invalidParamName: "pixel_id",
                                    invalidParamValue: q,
                                    method: "set",
                                    params: e,
                            ...
                            case "pcmInstagramTriggerAttribution":
                                ...
                                V.pluginConfig.set(C, "pcmInstagramTriggerAttribution", {
                                    pcmInstagramTriggerAttributionURL: j.INSTAGRAM_TRIGGER_ATTRIBUTION
                                });
                                break;
                    ...
                    function Y(a, b, c) {
                        ...
                        if (P.call(T, d)) {
                            b != null && C(T[d].userData) ? (T[d].userData = e ? b || {} : {}, W.loadPlugin("identity")) : M({
                                pixelID: d,
                    ...
                    function ma(a, b, c) {
                        b = b || {}, p.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), Z.call(this, a, b, c)
                    }
                    ...
                    function pa(a, b, c, d) {
                        ...
                        try {
                            e.append("ud", a && a.userData || {}, !0), e.append("udff", a && a.userDataFormFields || {}, !0)
                        } catch (b) {
                            I.trigger(a)
                        }
                        ...
                        b = H.trigger(a, b, c, d);
                        B(b, function(a) {
                            return B(F(a), function(b) {
                                if (e.containsKey(b)) {
                                    if (!ha.has(b)) throw new Error("Custom parameter " + b + " has already been specified.")
                                } else e.append(b, a[b])
                            })
                        });
                        e.append("it", O);
                        ...
                        e.append("coo", c);
                        d = V.pluginConfig.getWithGlobalFallback(a ? a.id : null, "dataProcessingOptions");
                        if (d != null) {
                    ...
                    function ua(a) {
                        a.instance = V, a.callMethod = X, a._initHandlers = [], a._initsDone = {}, a.send = oa, a.getEventCustomParameters = pa, a.addInitHandler = sa, a.getState = ta, a.init = Y, a.set = ja, a.loadPlugin = function(a) {
